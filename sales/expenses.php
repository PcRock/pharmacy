                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="../vendor/Services/item_ops.php" method="post">
                                            <div class="form-group">
                                              ...
                                              <textarea class="form-control" placeholder="Please Briefly Explain Expense " name="expense_title" id="" rows="3"></textarea>
                                            </div>
                                            <div class="form-group">
                                              <label for="">Cost Expense</label>
                                              <input type="number"
                                                class="form-control" name="cost" id="" aria-describedby="helpId" placeholder="Cost">
                                              
                                            </div>
                                            <input type="hidden" name="username" value="<?php echo $_SESSION['username'] ?>">
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" name="save_expense" class="btn btn-primary">Save Report</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
