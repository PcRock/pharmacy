                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title text-center"><h1 class="display-4 text-center">POS/Transfer Transaction</h1></h4><hr class="my-1">
                                        <table class=table table-bordered table-sm table-inverse table-responsive-sm table-responsive-lg" id="dataTable">
                                            <thead class="thead-inverse">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $json_data = json_decode($items->getAllPOSReport());
                                                        if($json_data != null){
                                                            foreach($json_data as $value){ ?>
                                                                <tr>
                                                                    <td scope="row"><?php echo $value->sn; ?></td>
                                                                    <td><?php echo $value->accountant; ?></td>
